...
```bash
python ml/vision/check_split.py --train data/v1/train/images --test data/v1/test/images --manifest data/v1/image_sessions.csv
```
...
`python ml/vision/eval_weights.py ml/vision/weights/cabbage.csv ml/vision/weights/tomato.csv`.
