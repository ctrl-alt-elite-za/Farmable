...
class Section {
  ...
  factory Section.fromJson(Map<String, dynamic> j) {
    ...
    return Section(
      ...
      currentCrop: j['current_crop'] == null ? null : Crop.parse(j['current_crop'] as String),
...
class Dashboard {
  ...
  factory Dashboard.fromJson(Map<String, dynamic> j) => Dashboard(
        ...
        approvedPlanIds: ((j['approved_plans'] as List?) ?? const [])
            .map((p) => p is String ? p : (p as Map<String, dynamic>)['id'] as String)
            .toList(),
...
class PlanningResult {
  ...
  factory PlanningResult.fromJson(Map<String, dynamic> j) {
    ...
    return PlanningResult(
      ...
      assumptions:
          ((scenario['assumptions'] as List?) ?? const []).cast<String>(),
    );
  }
...
enum PlanStatus {
  ...
  static PlanStatus parse(String v) =>
      PlanStatus.values.firstWhere((s) => s.name == v,
