...
class WeatherJob(Base):
    ...
    id: Mapped[str] = mapped_column(Text, primary_key=True)
    latitude_tenths: Mapped[int] = mapped_column(Integer)
    longitude_tenths: Mapped[int] = mapped_column(Integer)
...
class WeatherRiskClimatology(Base):
    ...
    plant_month: Mapped[int] = mapped_column(Integer, primary_key=True)
