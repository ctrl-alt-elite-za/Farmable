...
import farmableCornLogo from './assets/farmable-corn-mark.svg'
    ...
    <div className="app-shell">
      ...
      <header className="site-header">
        ...
        <nav className={menuOpen ? 'site-nav site-nav--open' : 'site-nav'} id="site-navigation" aria-label="Main navigation">
          ...
          <a className="nav-cta" href="#demo" onClick={(event) => navigateTo(event, 'demo')}>Open Farmable</a>
        </nav>
      </header>
      ...
      <main id="main-content">
        <section className="hero" id="top" aria-labelledby="hero-heading">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a className="primary-button" href="#demo" onClick={(event) => navigateTo(event, 'demo')}>Open farmer view <ArrowRight size={19} aria-hidden="true" /></a>
            ...
            <div className="hero-notes" aria-label="Product principles">
              <span>Works without signal</span>
              <span>Camera-led tasks</span>
              <span>Advice shows its limits</span>
            </div>
          </div>
        ...
        <section className="story-section story-section--start" id="field-plan" aria-labelledby="field-heading">
          <article className="story-panel">
            <div className="story-meta"><span>01</span></div>
        ...
        <section className="story-section story-section--end" id="crop-check" aria-labelledby="crop-heading">
          <article className="story-panel story-panel--gold">
            <div className="story-meta"><span>02</span></div>
        ...
        <section className="story-section story-section--start" id="market-route" aria-labelledby="market-heading">
          <article className="story-panel story-panel--dark">
            <div className="story-meta"><span>03</span></div>
        ...
        <section className="closing-section" aria-labelledby="closing-heading">
          <div>
            <p className="section-kicker">Farmable</p>
            <h2 id="closing-heading">Take Farmable into the field.</h2>
            <p>Your field plan, crop checks, market routes and costs stay together, even when the signal drops.</p>
          </div>
      ...
      <footer className="site-footer">
        ...
        <p>Farm records and field guidance for South African smallholders.</p>
      </footer>
    </div>
  )
}
